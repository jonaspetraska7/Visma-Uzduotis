...
namespace VismaTask
{
    public static class MeetingController
    {
        ...
        public static void Delete()
        {
            ...
            var selection = UI_Helper.AskForSelection(variants, "Pasirinkite kuris susitikima norite istrinti : ");
            ...
            {
                Console.Clear();
                Console.WriteLine("Susitikimo {0} istrinti negalima. Nesate jo savininkas !", meeting.Name);
                Console.ReadKey();
            }
        }
        ...
        public static void AddPerson()
        {
            ...
            if (!meeting.People.Contains(user))
            {
                ...
                if(key == ConsoleKey.Y)
                {
                    ...
                    Console.Clear();
                    Console.WriteLine("Pridedamas {0} prie susitikimo {1} laiku {2}",user.Name,meeting.Name,meeting.StartDate);
                    Console.ReadKey();
                }
            }
            else
        ...
        public static void RemovePerson()
        {
            ...
            if(meeting.ResponsiblePersonId != user.Id)
            {
                ...
                DB.SaveChanges();
                Console.WriteLine("Zmogus {0} pasalintas is susitikimo {1}",user.Name,meeting.Name);
                Console.ReadKey();
            }
            else
            {
